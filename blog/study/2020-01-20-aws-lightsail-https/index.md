...
description: AWS LightSail 로드 밸런서를 사용하여 HTTPS 보안 연결.
date: '2020-01-20'
authors:
  - righthot
tags:
...
![aws https](./https09.png)

등록 후 잠시 기다리면... 아래 처럼 사용가능한 상태가 됩니다.

![aws https](./https10.png)
